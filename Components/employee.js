...
// console.log('dd',data)
let saveArr = JSON.stringify(data);
// console.log('ss',saveArr)
...
let id= objArr[i].id
let fullName=objArr[i].fullName
let department=objArr[i].department
let level=objArr[i].level
let imageUrl=objArr[i].imageUrl
//console.log(imageUrl)
let newE = new Employee(id,fullName,department,level,imageUrl).render()
//console.log("nn",newE)
}}
 }
